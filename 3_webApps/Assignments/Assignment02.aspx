        ...
        <form runat="server" class="templatemo-login-form">
            <table style="margin: auto; width: 70%;">
                <tr>
                    ...
                    <td><asp:TextBox class="form-control" Width="150px" Height="16px" ID="TBName" runat="server"></asp:TextBox></td>
                    <td style="width: 100px"></td>
                </tr>
                <tr>
                    <td><span>Email Address: </span></td>
                    <td><asp:TextBox class="form-control" Width="150px" Height="16px" ID="TBEmail" runat="server"></asp:TextBox></td>
                    <td></td>
                </tr>
                <tr>
                    <td><span>Login Name: </span></td>
                    <td><asp:TextBox class="form-control" Width="150px" Height="16px" ID="TBLogin" runat="server"></asp:TextBox></td>
                    <td></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3"><asp:TextBox class="form-control" Width="100%" Height="250" ID="TBReason" runat="server" TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                <tr>
