...
public class NVPAPICaller
{
    ...
    public string APIUsername = "bendorf.mike-facilitator_api1.gmail.com";
    private string APIPassword = "K2KXZ9AYEGSWP8HK";
    private string APISignature = "ALxGJYdzDSvPgFHgC84ph2vBgxZUALfoBxlrFpkMrFDxnABleXooEQL1";
    ...
    //The ShortcutExpressCheckout method collects the test purchase information and product details from the shopping cart and calls the SetExpressCheckout PayPal function
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44395/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44395/Checkout/CheckoutCancel.aspx";
    ...
    //The GetCheckoutDetails method confirms purchase details and calls the GetExpressCheckoutDetails PayPal function before making the test purchase.
    ...
    //The DoCheckoutPayment method completes the test purchase from the testing environment by calling the DoExpressCheckoutPayment PayPal function.
